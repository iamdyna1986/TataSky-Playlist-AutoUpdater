...
if [[ $OSTYPE == 'linux-android'* && $(echo "$TERMUX_VERSION" | cut -c 3-5) -ge "117" ]]; then
    pkg install git
    git clone https://github.com/iamdyna1986/TataSky-Playlist-AutoUpdater || { rm -rf TataSky-Playlist-AutoUpdater; git clone https://github.com/iamdyna1986/TataSky-Playlist-AutoUpdater; }
